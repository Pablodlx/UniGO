...
def set_json_dumps(dumps: JsonDumpsFunction, context: abc.AdaptContext | None = None) -> None:
    """
...
def set_json_loads(loads: JsonLoadsFunction, context: abc.AdaptContext | None = None) -> None:
    """
...
def _get_current_dumper(adapters: AdaptersMap, cls: type, format: PyFormat) -> type[abc.Dumper]:
    try:
