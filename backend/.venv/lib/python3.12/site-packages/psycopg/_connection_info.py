...
class ConnectionInfo:
    ...
    def get_parameters(self) -> dict[str, str]:
        ...
        defaults = {
            i.keyword: i.compiled for i in pq.Conninfo.get_defaults() if i.compiled is not None
        }
        ...
        return {
            ...
            if i.val is not None and i.keyword != b"password" and i.val != defaults.get(i.keyword)
        }
