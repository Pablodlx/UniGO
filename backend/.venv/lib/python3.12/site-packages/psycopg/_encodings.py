...
py_codecs.update((k.replace("_", "").encode(), v) for k, v in _py_codecs.items() if "_" in k)
...
_re_clean = re.compile(f"[^{string.ascii_lowercase}{string.ascii_uppercase}{string.digits}_]")
