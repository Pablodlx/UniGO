...
class Composed(Composable):
    ...
    def join(self, joiner: SQL | LiteralString) -> Composed:
        ...
        if isinstance(joiner, str):
            ...
            raise TypeError(
                "Composed.join() argument must be strings or SQL," f" got {joiner!r} instead"
            )
    ...
    def __init__(self, *strings: str):
        ...
        for s in strings:
            if not isinstance(s, str):
                raise TypeError(f"SQL identifier parts must be strings, got {s!r} instead")
...
class Placeholder(Composable):
    ...
    def __init__(self, name: str = "", format: str | PyFormat = PyFormat.AUTO):
        ...
        if not isinstance(format, PyFormat):
            raise TypeError(f"expected PyFormat as format, got {type(format).__name__!r}")
